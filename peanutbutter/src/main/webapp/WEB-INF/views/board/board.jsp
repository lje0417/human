...
<body>
    <div class="container">
        <div class="top">
            <div class="title">
                <img src="/peanutbutter/resources/image/board.png" style="width: 30px;">
                <span>게시판</span>
            </div>
        </div>
        <div class="search_container">
            ...
            <img style="margin-left: 30px;margin-right: 30px;" src="/peanutbutter/resources/image/search.png" onclick="searchTable()">
        </div>
                ...
                <tbody class="tbody">
                    <c:forEach var="boardDTO" items="${list}">
                        <tr>
                            <td>
                                <c:choose>
                                    <c:when test="${boardDTO.notice eq 'true'}">공지사항</c:when>
                                    <c:otherwise>${boardDTO.bno}</c:otherwise>
                                </c:choose>
                            </td>
        ...
        <div class="boardPage">
            <%
                ...
                int sectionCount = 3; // Number of pages to show in a section
                int sectionPos = (int)Math.ceil((double)currentPage / sectionCount);
                int sec_first = (sectionPos - 1) * sectionCount + 1;
                int sec_last = sectionPos * sectionCount;
                if (sec_last > totalPageCount) {
                    sec_last = totalPageCount;
                }
            %>
            ...
            <c:if test="${sec_last < totalPageCount}">
