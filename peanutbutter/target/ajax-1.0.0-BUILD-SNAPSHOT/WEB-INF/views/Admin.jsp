...
<body>
    <div class="container">
        <div class="header">
            <div class="top">
                <div class="item" style="flex-grow: 1"><img src="/peanutbutter/resources/image/logo.png"></div>
                <div class="item" style="flex-grow: 4"></div>
                <div class="item" style="flex-grow: 1;"><img src="/peanutbutter/resources/image/person.png"><span
                        style="color: #D5D5D5;font-weight: bold;position: relative;top: -5px;right: -5px;">${loginDTO.ename} 님</span>
                </div>
                <div class="item" style="flex-grow: 1;"><img src="/peanutbutter/resources/image/offBtn.png"></div>
            </div>
            <div class="top2">
    ...
    topMenus.forEach(menu => {
        menu.addEventListener('click', () => {
            ...
            if (menuType === '생산') {
                ...
                iframe.src = 'http://localhost:8080/peanutbutter/pl';
                ...
                let iframe = document.getElementById('contentFrame');
                iframe.src = 'http://localhost:8080/peanutbutter/pt_stock';
                ...
                let iframe = document.getElementById('contentFrame');
                iframe.src = 'http://localhost:8080/peanutbutter/Chart';
                ...
                let iframe = document.getElementById('contentFrame');
                iframe.src = 'http://localhost:8080/peanutbutter/board';
