...
import human.class1.ajax.pl_spDAO.Plan_ManagementDAO;
import human.class1.ajax.pl_spDAO.Specification_ManagementDAO;
...
@Service
public class Plan_ManagementServiceImpl implements Plan_ManagementService{

	@Autowired
	Plan_ManagementDAO plDAO;
	@Autowired
	Specification_ManagementDAO spDAO;
