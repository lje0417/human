...
<body>
    <div class="container">
        ...
        <div class="search_container">
			<form method="post" action="insert_sh">
            <div class="searchcon">
                <div style="padding-right:15px;">제품명(*)</div>
                <select style="height: 40px;" class="제품select" name="product_name" onchange="take(this)">
                    <option value="-----">-----</option>
                ...
                <div class="search-box">
                    <input id="제품코드" type="text" name="product_code" readonly>
                </div>
            </div>
            <div class="searchcon">
                <div style="padding-right:48px;">통화</div>
                <div class="search-box">
                    <select style="height: 40px;" class="제품select" name="shipping_currency">
                    <option value="-----">-----</option>
                ...
                <input style="height: 30px; font-size: 20px; margin-left: 11px;" type="date" id="date" max="2025-06-20"
                    min="2001-06-05" value="2024-10-17" name="shipping_date" >
            </div>
            <div class="searchcon">

                <div style="padding-right:17px;">출고수량</div>
                <div class="search-box">
                    <input type="text" id="count" name="shipping_amount">
                </div>
            ...
            <div class="searchcon">
                ...
                <div class="search-box">
                    <input type="text" id="spwarehouse" name="shipping_warehouse">
                </div>
            </div>
            <div class="searchcon">
                <div style="padding-right:17px;">거래처</div>
                <div class="search-box">
                <input type="text" name="shipping_arrival">
                </div>
            </div>
