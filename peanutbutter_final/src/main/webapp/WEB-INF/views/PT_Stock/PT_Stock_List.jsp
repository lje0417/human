    ...
    <div class="container">
        ...
        <form id="searchform" action="pt_stock" method="get"> 
            <select class="select" name=optionvalue>
                ...
                <option value="part_name" <c:if test="${map.optionvalue == 'partname'}">selected</c:if>>부품명</option>
                <option value="part_modelname" <c:if test="${map.optionvalue == 'part_modelname'}">selected</c:if>>모델명</option>
                <option value="receving_warehouse" <c:if test="${map.optionvalue == 'receving_warehouse'}">selected</c:if>>부품 창고</option>
            </select>
...
<script>
    ...
    function searchpage(num){
    	...
    	let url = "/peanutbutter/pt_stock?page=" + num;
    	
    	
    	if(a != ''){    		
//     		location.href="/peanutbutter/pl?optionvalue="+a+"&search="+b+"&page=num";
