...
<body>
	<div class="container">
		...
		<div class="search_container">
			<div class="search">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<form id="searchform" action="bom" method="get">
					<select id="select" name="optionvalue" class="inputTextHeight">
						...
						<option value="product_number"
							<c:if test="${map.optionvalue == 'product_number'}">selected</c:if>>제품코드</option>
		...
		<div style="text-align: center;">
			...
			<div class="regBtn_div">
				<span class="Btn_css" onclick="deleteRow()">선택된 행 삭제</span> <span
					class="Btn_css" id="regBtn" onclick="commitReg()">BOM 작성</span>
			</div>
		</div>
		<form id="deleteone" action="delete_bom" method="post">
...
function searchTable() { // 돋보기 버튼을 클릭했을 때 동작하는 함수
    ...
    function commitReg(){
    	location.href="/peanutbutter/insert_bom";
    }
    	a = '${map.optionvalue}';
    	b = '${map.search}';
    ...
    function searchpage(num){
        ...
        let url = "/peanutbutter/bom?page=" + num;
