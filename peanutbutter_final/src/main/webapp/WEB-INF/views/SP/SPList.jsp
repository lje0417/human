                ...
                <tbody class="tbody">
                	<c:forEach var="SP" items="${map.list }">
                    	<tr>
                        	...
                        	<td><a href="sp_detail?plan_start_date=${SP.plan_start_date}">${SP.product_name}</a></td>
                            ...
                            <select id = select_status name="optionvalue_status" onchange="take(this, '${SP.specification_number}')">
                                <option value="-----"
                                	<c:if test="${empty map.optionvalue || map.optionvalue == '-----'}">selected</c:if>>-------</option>
                                <option value="stay"
                                	<c:if test="${SP.specification_status == 'stay'}">selected</c:if>>대기</option>
                                <option value ="underway"
                                	<c:if test="${SP.specification_status == 'underway'}">selected</c:if>>진행중</option>
                                <option value ="complete"
                                	<c:if test="${SP.specification_status == 'complete'}">selected</c:if>>완료</option>
                            </select>
                        </td>
                    </tr>
                   </c:forEach>
...
function searchTable() { // 돋보기 버튼을 클릭했을 때 동작하는 함수
    ...
    function searchpage(num){
        ...
        let url = "/peanutbutter/sp?page=" + num;
