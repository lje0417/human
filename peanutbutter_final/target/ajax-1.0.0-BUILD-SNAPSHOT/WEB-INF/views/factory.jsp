...
<body>
    <div class="container">
        <div class="top">
            <img src="/peanutbutter/resources/image/directory.png" style="width: 30px;">
            <span>공정 관리</span>
            <select class="select">
                <option value="-----">-----</option>
            ...
            <img src="/peanutbutter/resources/image/search.png" style="margin-left: 10px;" onclick="searchTable()">
