...
<body>
<form action='/peanutbutter/Process' method="post" >
    <div class="container">
        <div class="top">
...
function commitReg() {
    ...
    for (let row of rows) {
        ...
        // 이미지 데이터 처리
        let image = row.querySelector('input[name="image"]').files.length > 0 ? row.querySelector('input[name="image"]').files[0].name : '이미지가없습니다';
